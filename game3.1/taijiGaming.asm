...
nowUp:
		...
		mov dword ptr[esi+16],offset headdownpath
		jmp exit
nowDown:
		mov dword ptr[esi+12],UP
		mov dword ptr[esi+16],offset headuppath
		jmp exit
nowLeft:
		mov dword ptr[esi+12],RIGHT
		mov dword ptr[esi+16],offset headrightpath
		jmp exit
nowRight:
		mov dword ptr[esi+12],LEFT
		mov dword ptr[esi+16],offset headleftpath
		jmp exit
	exit:
		ret
