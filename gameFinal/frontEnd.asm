              ...
              .if eax == WM_KEYDOWN
                   ...
                   .if ebx==" "
                        .if isOver==1       ;gameover界面
                            ...
                            invoke initialSnake,addr snake1,blockCol-5,9,blockCol-4,9,offset headleftpath1
                            mov edi,offset snake1
                            mov dword ptr [edi+20],offset bodypath1
                            invoke initEggs
                            ;invoke initialSnake,addr snake,4,9,3,9,offset headrightpath ;对蛇进行初始化
                            ;invoke initialSnake,addr snake1,blockCol-5,9,blockCol-4,9,offset headleftpath1
